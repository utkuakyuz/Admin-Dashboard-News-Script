...
<div class="wrapper px-4 mt-n10">
  <h3 class="mt-3 mb-3 page-title">Onay Bekleyen Yorumlar</h3>
  
<div class="card mb-4">
  <div class="card-header">Onay Bekleyen Yorumlar
      <router-link
    ...
    <div class="fixed-columns">
      ...
      <tbody id="">
        <tr v-for="comment in pendingCommentsList.list" :key="comment.ID">
          ...
          <td><button type="button" class="btn btn-success btn-md" v-on:click="ConfirmComment(comment.ID, 1)">
              Onayla</button></td>
