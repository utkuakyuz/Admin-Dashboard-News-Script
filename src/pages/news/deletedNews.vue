<template>
 <div class="wrapper px-4 mt-n10">
  <h3 class="mt-3 mb-3 page-title">Silinmiş Haberler</h3>
 
  <div class="card mb-4">
   <div class="card-header">Silinmiş Haberler
      <router-link
    ...
    <div class="fixed-columns">
     <div class="table-container px-4 mt-n10 table-responsive">
      <table class="table table-striped table-bordered align-middle text-center">
       ...
       <tbody id="">
        <tr v-for="New in deletedNewsList.list" :key="New.ID">
         <td>{{ New.ID }}</td>
         <td>{{ New.username }}</td>
         <td>{{ New.title}}</td>
...
import { ref } from "vue";
import { deletedNews, deletedNewsList } from "@/store/content";
getPendingNews();
